	...
	<div class="container footer-grid">
		...
		<div class="footer-contact glass-card">
			...
			<p class="footer-social">
				<a href="https://instagram.com/baharcollectionss" class="footer-social__link" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'اینستاگرام بهار شاپ', 'bahar-shop' ); ?>">
				...
				<a href="https://wa.me/989035233046" class="footer-social__link" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'واتساپ بهار شاپ', 'bahar-shop' ); ?>">
				...
				<a href="tel:+989035233046" class="footer-social__link" aria-label="<?php esc_attr_e( 'تماس با بهار شاپ', 'bahar-shop' ); ?>">
